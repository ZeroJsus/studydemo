...
function (_super) {
  ...
  WebSocketSubject.prototype._connectSocket = function () {
    ...
    socket.onopen = function (e) {
      ...
      _this.destination = _Subscriber.Subscriber.create(function (x) {
        if (socket.readyState === 1) {
          ...
          var msg = (0, _tryCatch.tryCatch)(serializer)(x);

          if (msg === _errorObject.errorObject) {
            _this.destination.error(_errorObject.errorObject.e);
    ...
    socket.onmessage = function (e) {
      ...
      var result = (0, _tryCatch.tryCatch)(deserializer)(e);
...
},{}],"node_modules/rxjs/_esm5/internal/util/not.js":[function(require,module,exports) {
"use strict";
...
},{}],"node_modules/rxjs/_esm5/internal-compatibility/index.js":[function(require,module,exports) {
"use strict";
...
},{"tslib":"node_modules/tslib/tslib.es6.js","../Subscriber":"node_modules/rxjs/_esm5/internal/Subscriber.js"}],"node_modules/rxjs/_esm5/internal/operators/throttleTime.js":[function(require,module,exports) {
"use strict";
...
},{"rxjs-compat":"node_modules/rxjs-compat/Rx.js"}],"demo1.js":[function(require,module,exports) {
var Rx = require('rxjs/Rx');

function $$(item) {
  return document.querySelectorAll(item).length != 1 ? document.querySelectorAll(item) : document.querySelectorAll(item)[0];
} // 可观察对象的设置以及订阅可观察对象的事件


var btn = $$('button'); // 订阅事件直接触发
...
},{}]},{},["C:/Users/Administrator/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","demo1.js"], null)
//# sourceMappingURL=/demo1.9a1b1713.map